...
abstract class AppLocalizations {
  ...
  /// No description provided for @profileSyncTest.
  ///
  /// In es, this message translates to:
  /// **'Probar sincronización en segundo plano'**
  String get profileSyncTest;

  /// No description provided for @profileSyncSnackbar.
  ///
  /// In es, this message translates to:
  /// **'Sincronización en segundo plano programada. Revisa la notificación en unos segundos.'**
  String get profileSyncSnackbar;

  /// No description provided for @syncNewAnimeSingle.
  ///
  /// In es, this message translates to:
  /// **'Nuevo anime disponible'**
  String get syncNewAnimeSingle;

  /// No description provided for @syncNewAnimePlural.
  ///
  /// In es, this message translates to:
  /// **'{count} animes nuevos disponibles'**
  String syncNewAnimePlural(Object count);

  /// No description provided for @syncNewEpisodeSingle.
  ///
  /// In es, this message translates to:
  /// **'Nuevo episodio disponible de {title}'**
  String syncNewEpisodeSingle(Object title);

  /// No description provided for @syncNewEpisodePlural.
  ///
  /// In es, this message translates to:
