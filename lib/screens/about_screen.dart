...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Acerca de', style: AppTextStyles.headline3),
        backgroundColor: AppColors.background,
      ),
      body: ListView(
        ...
        children:[
          ...
          Text('Proposito de la aplicación', style: AppTextStyles.headline3,),
          Text('Library Anime nace de una necesidad real: la información sobre el anime está fragmentada en decenas de plataformas de streaming y sitios externos, obligando al usuario a abrir múltiples apps para encontrar un solo título.\n\n'
